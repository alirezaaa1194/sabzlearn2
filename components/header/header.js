import { isUserLogedIn, getUserInfo, getMenus, logOut, getUserTokenFromcookie, getQueryParams } from "../../js/funcs/utils.js";
...
class Header extends HTMLElement {
  constructor() {
    ...
    this.dropDownAccountCover = this.shadowRoot.querySelector(".dropDownAccountCover");
    ...
    this.search_box_input1 = this.shadowRoot.querySelector(".search_box_input1");

    this.search_box_btn1 = this.shadowRoot.querySelector(".search_box_btn1");

    this.search_box_input2 = this.shadowRoot.querySelector(".search_box_input2");
    ...
    if (this.isUserLogedIn()) {
      ...
      this.shadowRoot.querySelector(".UserAccountBtn").classList.remove("active");
  ...
  changeThemeMode() {
    if (this.isDark == true) {
      ...
      document.documentElement.style.setProperty("--primaryLightColor", "rgb(28 28 40)");
      document.documentElement.style.setProperty("--borderColor", "rgb(50 51 77)");
      document.documentElement.style.setProperty("--hoverColor", "rgb(28 28 40)");
      document.documentElement.style.setProperty("--hoverBorderColor", "rgb(119 124 148)");
      document.documentElement.style.setProperty("--secondDynamicCoor", "rgb(50 51 77)");
      document.documentElement.style.setProperty("--TextLightColor", "#fff");
      document.documentElement.style.setProperty("--activeMenuItem2Hover", "#fff");
      ...
      document.documentElement.style.setProperty("--FerechexHoverColor", "rgb(74 75 109)");
      document.documentElement.style.setProperty("--Warning-bg-color", "40, 41, 61");
      document.documentElement.style.setProperty("--category-color", "rgb(250 204 21)");
      document.documentElement.style.setProperty("--category-bg-color", "rgb(250 204 21 / 0.1)");
      document.documentElement.style.setProperty("--SecondTextLightColor", "rgb(148 163 184)");
      document.documentElement.style.setProperty("--bannerRedColor", "rgb(239 68 68)");

      document.documentElement.style.setProperty("--comment_background", "rgb(50 51 77)");
      document.documentElement.style.setProperty("--reply_background", "rgb(74 75 109)");
      document.documentElement.style.setProperty("--textarea_background", "rgb(50 51 77)");

      document.documentElement.style.setProperty("--textarea_color", "rgb(100 116 139)");
      ...
      document.documentElement.style.setProperty("--blue_btn_hover", "rgb(37 99 235)");

      document.documentElement.style.setProperty("--cancel_btn", "rgb(50 51 77)");
      document.documentElement.style.setProperty("--cancel_btn_hover", " rgb(74 75 109 )");

      document.documentElement.style.setProperty("--video_download_bg_color", "46, 213, 115, .1");
      document.documentElement.style.setProperty("--video_download_color", "46, 213, 115");

      document.documentElement.style.setProperty("--video_download_hover_bg_color", "46, 213, 115, .1");

      document.documentElement.style.setProperty("--file_download_bg_color", "250, 204, 21, .1");
      document.documentElement.style.setProperty("--file_download_color", "250, 204, 21, 1");
      document.documentElement.style.setProperty("--file_download_hover_bg_color", "250, 204, 21, .1");

      document.documentElement.style.setProperty("--session_accordion_body_bg", "rgb(40 41 61)");

      document.documentElement.style.setProperty("--session_accordion_hover_body_bg", "rgb(50 51 77)");
    } else {
      document.body.classList.remove("dark");
      //light
      document.documentElement.style.setProperty("--lightColor", "#fff");
      document.documentElement.style.setProperty("--primaryLightColor", "rgb(243 244 246)");
      document.documentElement.style.setProperty("--borderColor", "rgb(243 244 246)");
      document.documentElement.style.setProperty("--hoverColor", "rgb(229 231 235)");
      document.documentElement.style.setProperty("--hoverBorderColor", "rgb(243 244 246)");
      document.documentElement.style.setProperty("--secondDynamicCoor", "#fff");
      document.documentElement.style.setProperty("--TextLightColor", "rgb(63 63 70)");
      document.documentElement.style.setProperty("--activeMenuItem2Hover", "#000");
      document.documentElement.style.setProperty("--cardTextColor", "rgb(100 116 139)");
      document.documentElement.style.setProperty("--mainColor", "rgb(243 244 246)");
      document.documentElement.style.setProperty("--FerechexHoverColor", "rgb(243 244 246)");
      document.documentElement.style.setProperty("--Warning-bg-color", "255, 255, 255");
      document.documentElement.style.setProperty("--category-color", "rgb(78 129 251)");
      document.documentElement.style.setProperty("--category-bg-color", "rgb(14 165 233 / 0.1)");
      document.documentElement.style.setProperty("--SecondTextLightColor", "rgb(100 116 139)");

      document.documentElement.style.setProperty("--bannerRedColor", "rgb(236 72 153)");

      document.documentElement.style.setProperty("--comment_background", "rgb(243 244 246)");

      document.documentElement.style.setProperty("--reply_background", "rgb(229 231 235)");
      document.documentElement.style.setProperty("--textarea_background", "rgb(243 244 246)");
      document.documentElement.style.setProperty("--textarea_color", " rgb(100 116 139)");

      document.documentElement.style.setProperty("--blue_btn", "rgb(14 165 233)");
      document.documentElement.style.setProperty("--blue_btn_hover", "rgb(2 132 199)");
      document.documentElement.style.setProperty("--cancel_btn", " rgb(229 231 235)");
      document.documentElement.style.setProperty("--cancel_btn_hover", " rgb(209 213 219)");

      document.documentElement.style.setProperty("--video_download_bg_color", "46, 213, 115, 1");
      document.documentElement.style.setProperty("--video_download_color", " 255, 255, 255");
      document.documentElement.style.setProperty("--video_download_hover_bg_color", "34, 197, 94");
      document.documentElement.style.setProperty("--file_download_bg_color", "250, 204, 21, 1");
      document.documentElement.style.setProperty("--file_download_color", "255, 255, 255");
      document.documentElement.style.setProperty("--file_download_hover_bg_color", "249, 161, 52");

      document.documentElement.style.setProperty("--session_accordion_body_bg", "rgb(255, 255, 255)");
      document.documentElement.style.setProperty("--session_accordion_hover_body_bg", "rgb(255, 255, 255)");
    }
  }
  ...
  openResponsiveSubMenu(elem) {
    if (elem.classList == "menuLink active") {
      ...
      this.shadowRoot.querySelectorAll(".menuLink").forEach(function (menuLinkItem) {
  ...
  menusGenerator(menus) {
    ...
    menus.forEach((menu) => {
      this.NavigationBar.insertAdjacentHTML(
        ...
        `
    <li>
    <a href="./course_category.html?cat=${menu.href}&catName=${menu.title}" class="NavItem">${menu.title} ${menu?.submenus?.length > 0 ? ' <i class="fa fa-angle-down"></i>' : ""}</a>
  </li>
    `
      );
      ...
      `
        ...
        menu.submenus.forEach((submenu) => {
          subMenusBox.insertAdjacentHTML(
            "beforeend",
            `
        <li><a ${menu.title != "مقالات" ? `href="course.html?name=${submenu.href}"` : `href="blog.html?bName=${submenu.href}"`}>${submenu.title}</a></li>
        `
          );
        });
      }
    ...
    menus.forEach((menu) => {
      this.menubar.insertAdjacentHTML(
        ...
        `
  <li class="menuItem">
      <a ${!menu?.submenus?.length && menu.title != "مقالات" ? `href="./course_category.html?cat=${menu.href}&catName=${menu.title}"` : ""}   
      
      ${!menu?.submenus?.length && menu.title === "مقالات" ? `href="blog_category.html"` : ""}  class="menuLink">
      ${menu.title} ${menu?.submenus?.length > 0 ? '<i class="fa fa-angle-down"></i>' : ""}
    </a>
 </li>
  ...
  `
      ...
      if (menu?.submenus?.length > 0) {
        menuItem.insertAdjacentHTML("beforeend", `<ul class="responsiveSubmenu"></ul>`);
  ...
  <a ${menu.title != "مقالات" ? `href="course.html?name=${submenu.href}"` : `href="blog.html?bName=${submenu.href}"`}  class="responsiveMenuLink">${submenu.title}</a>
</li>
  ...
  insertPanelLink() {
    if (this.isUserLogedIn()) {
      this.getUserInfo().then((data) => {
        if (data.role === "ADMIN") {
          this.NavigationBar.insertAdjacentHTML("beforeend", `<li><a href="./panel/main">پنل مدیریت</a></li>`);
          this.menubar.insertAdjacentHTML("beforeend", `<li class="menuItem"><a href="./panel/main" class="menuLink">پنل مدیریت</a></li>`);
        }
      });
    }
  }
